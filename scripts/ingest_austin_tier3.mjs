...
// 10 Austin Arbitrage Targets
const TARGETS = [
    { city: 'Pflugerville', zip: '78660' },
    { city: 'Round Rock', zip: '78664' },
    { city: 'Georgetown', zip: '78626' },
    { city: 'Johnson City', zip: '78636' },
    { city: 'San Marcos', zip: '78666' },
    { city: 'Cedar Park', zip: '78613' },
    { city: 'Buda', zip: '78610' },
    { city: 'Taylor', zip: '76574' },
    { city: 'Manor', zip: '78653' },
    { city: 'Marble Falls', zip: '78654' }
];
...
async function run() {
    console.log("🚀 Starting AUSTIN Arbitrage Ingestion...");
    ...
    for (const target of TARGETS) {
        ...
        const profile = `Located in the complex geological transition zone of Central Texas, ${target.city} straddles the Balcones Fault. Homes here are frequently built on a volatile mix of shallow limestone bedrock and pockets of highly expansive Blackland Prairie clay, creating severe differential settlement risks that require specialized underpinning.`;
        ...
        if (soil) {
            ...
            const { error: soilError } = await supabase.from('soil_cache').upsert({
                ...
                component_name: soil.component_name || 'Edwards Plateau Limestone/Clay',
    ...
    console.log("\n🎉 AUSTIN ARBITRAGE BATCH COMPLETE! Sitemap automatically updated.");
}
