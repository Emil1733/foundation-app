...
// 25 Houston Arbitrage Targets
const TARGETS = [
    { city: 'Richmond', zip: '77469' },
    { city: 'Huntsville', zip: '77320' },
    { city: 'Sugar Land', zip: '77479' },
    { city: 'Pearland', zip: '77584' },
    { city: 'Montgomery', zip: '77356' },
    { city: 'Cleveland', zip: '77327' },
    { city: 'Katy', zip: '77494' },
    { city: 'Pasadena', zip: '77502' },
    { city: 'Dayton', zip: '77535' },
    { city: 'League City', zip: '77573' },
    { city: 'Spring', zip: '77379' },
    { city: 'Cypress', zip: '77429' },
    { city: 'The Woodlands', zip: '77380' },
    { city: 'Baytown', zip: '77520' },
    { city: 'Friendswood', zip: '77546' },
    { city: 'Galveston', zip: '77550' },
    { city: 'Missouri City', zip: '77459' },
    { city: 'Humble', zip: '77338' },
    { city: 'Kingwood', zip: '77339' },
    { city: 'Deer Park', zip: '77536' },
    { city: 'Conroe', zip: '77301' },
    { city: 'Texas City', zip: '77590' },
    { city: 'Brenham', zip: '77833' },
    { city: 'Stafford', zip: '77477' },
    { city: 'Magnolia', zip: '77354' }
];
...
async function run() {
    console.log("🚀 Starting HOUSTON Arbitrage Ingestion...");
    ...
    for (const target of TARGETS) {
        ...
        const profile = `Located in the Greater Houston Gulf Coast region, ${target.city} is heavily impacted by deep, highly expansive Beaumont and Lissie clay formations. The region's severe humidity, frequent flooding, and intense summer droughts cause radical volumetric shifts in the soil, leading to rampant slab-on-grade foundation failures.`;
        ...
        if (soil) {
            ...
            const { error: soilError } = await supabase.from('soil_cache').upsert({
                ...
                component_name: soil.component_name || 'Gulf Coast Clay',
    ...
    console.log("\n🎉 HOUSTON ARBITRAGE BATCH COMPLETE! Sitemap automatically updated.");
}
