...
async function runResearch() {
    let markdown = `# The Florida Sinkhole Project: Tampa & Orlando\n\n`;
    ...
    for (const [clusterName, cities] of Object.entries(FLORIDA_CLUSTERS)) {
        ...
        try {
            ...
            // Adding a delay to prevent Cloudflare/WAF rate limits from DataForSEO
    ...
    fs.writeFileSync('c:\\Users\\tevat\\nicheanalyzer\\foundation-app\\florida-research-tampa.md', markdown);
    console.log(`\n🎉 Tampa/Orlando Research complete! Output saved to florida-research-tampa.md`);
}
