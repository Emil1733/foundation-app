...
async function runResearch() {
    let markdown = `# The Suburban & Secondary Market Expansion Research (Safe Mode)\n\n`;
    ...
    fs.writeFileSync('c:\\Users\\tevat\\nicheanalyzer\\foundation-app\\suburb-research-safe.md', markdown);
    console.log(`\n🎉 Suburban Research complete! Output saved to suburb-research-safe.md`);
}
