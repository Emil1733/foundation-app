...
const CITIES = [
    "Katy", "Cypress", "Sugar Land", "Pearland", "Spring",
    "League City", "Conroe", "Tomball", "The Woodlands", "Baytown",
    "Missouri City", "Pasadena", "Galveston", "Friendswood", "Humble",
    "Kingwood", "Richmond", "Rosenberg", "Alvin", "Bellaire",
    "Stafford", "Seabrook", "Deer Park", "Webster", "La Porte",
    "Dickinson", "Texas City", "Lake Jackson", "Angleton", "Freeport",
    "Channelview", "Crosby", "Dayton", "Liberty", "Magnolia",
    "Montgomery", "Willis", "Huntsville", "Navasota", "Brenham",
    "Sealy", "Brookshire", "Hempstead", "Waller", "Cleveland",
    "Splendora", "New Caney", "Porter", "Huffman", "Jersey Village"
];
...
async function runResearch() {
    console.log(`📡 Querying Google Ads API for Search Volume (Houston)...`);
    ...
    try {
        ...
        console.log(`📡 Querying DataForSEO Labs for true organic KD (Houston)...`);
        ...
        let markdown = `# TRUE Houston Cluster Expansion Targets (Position 1-3 Arbitrage)\n\n`;
        ...
        fs.writeFileSync('c:\\Users\\tevat\\nicheanalyzer\\foundation-app\\houston-research.md', markdown);
        console.log(`🎯 Found ${winningKeywords.length} TRUE arbitrage targets! Saved to houston-research.md`);
