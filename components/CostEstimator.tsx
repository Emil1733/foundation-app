  ...
  return (
    <div className="bg-slate-900 rounded-3xl shadow-2xl overflow-hidden my-12 border border-slate-700 font-sans">
      <div className="bg-slate-950 px-6 py-5 border-b border-slate-800 flex items-center gap-3">
        ...
        <h2 className="text-xl font-extrabold text-white tracking-wide uppercase">What Should You Do Next?</h2>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="p-6 md:p-8 bg-slate-900">
          <p className="text-slate-400 font-bold mb-6 uppercase tracking-widest text-xs">Choose the closest match</p>
        ...
        <div className="p-6 md:p-8 bg-slate-950 border-t lg:border-t-0 lg:border-l border-slate-800">
          <p className="text-slate-500 font-bold mb-6 uppercase tracking-widest text-xs">Your Next Step</p>
          {!activeLevel ? (
            ...
            <div className="min-h-[320px] flex flex-col">
              <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6 mb-6">
                <div className="flex justify-between gap-4 mb-4"><span className="text-slate-400 font-bold text-sm uppercase">What still needs to be checked</span><span className="text-right text-red-300 text-sm">{activeLevel.cannot}</span></div>
                <div className="flex justify-between gap-4 border-t border-slate-800 pt-4"><span className="text-emerald-400 font-extrabold uppercase flex items-center gap-2"><ShieldAlert className="w-5 h-5"/> Recommended next step</span><span className="text-right text-white font-extrabold">{activeLevel.next}</span></div>
              </div>
              ...
              <form action="/book-analysis" className="mt-8 flex flex-col sm:flex-row gap-3">
                ...
                <button type="submit" className="w-full sm:w-auto text-slate-900 bg-emerald-400 hover:bg-emerald-300 font-extrabold px-6 py-4 rounded-xl">Request a Foundation Evaluation</button>
              </form>
            </div>
          )}
        </div>
