...
const getDynamicIntro = (city: string, soilName: string, risk: string) => {
  const hooks = [
    ...
    `A ${risk} map classification is a screening signal, not a repair prescription. In ${city}, compare the soil record with crack history, drainage, and floor-elevation evidence.`,
